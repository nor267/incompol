...
export default function HistoryDesktop({ dates }) {
    return (
        <>
            <div className="top-line relative flex justify-between grid grid-cols-4">
                <div className="hidden lg:block absolute lg:top-33 xl:top-32 2xl:top-31.5 left-1/2 -translate-x-1/2 z-0 lg:h-[300px] xl:h-[350px] lg:w-[1050px] xl:w-[1200px] 6xl:h-[360px]  6xl:w-auto 2xl:h-auto 2xl:w-[1500px] 4xl:w-[1500px] ">
                    <img src={line} className=" object-cover h-full"></img>
                    <div className="absolute -right-6 top-6 hidden 3xl:block">
