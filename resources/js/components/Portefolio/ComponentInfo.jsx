...
export default function ComponentInfo({ image, title, onClick }) {
    return (
        <div className="h-screen bg-azul flex justify-center items-center absolute z-80 w-screen left-0 flex flex-col xl:px-[244px]">
            <img
                src={closeComponent}
                className="absolute xl:top-15 xl:right-40 cursor-pointer"
                onClick={onClick}
            ></img>
            <div className="flex items-center w-full justify-between">
                <img src={triangleWhite} className="rotate-90 xl:h-5"></img>
            ...
            <div className="flex w-full xl:pt-30 xl:gap-46">
                <h1 className="uppercase font-black text-white xl:text-[32px] xl:leading-[38px] tracking-[0.14em]">
                    Steering<br></br> Wheels
                </h1>
                <section className="xl:text-[15px] xl:leading-[22px] tracking-[0.03em] font-light text-white">
                    <p>Spokes</p>
                    <p>Hub & Plate assy</p>
                    <p>Contact ring</p>
                    <p>Various</p>
