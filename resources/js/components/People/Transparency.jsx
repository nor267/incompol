    ...
    return (
        <>
            ...
            <div className="xl:pt-26 flex justify-center items-center flex-col xl:pb-52">
                ...
                <button className="border-3 border-laranja font-bold xl:text-[20px] uppercase px-4 py-1 text-laranja rounded-[40px] hover:text-azul hover:border-azul xl:mt-13 cursor-pointer duration-300 transition-all">
                    Código de conduta
                </button>
            </div>
        </>
