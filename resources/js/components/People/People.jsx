...
export default function People() {
    return (
        <>
            ...
            />
            <div className="bg-azul xl:h-[579px] flex text-white xl:mt-40">
                <div className="flex">
                    <img
                        src={market1}
                ...
                <div className="xl:pl-[130px] xl:pt-[150px]">
                    ...
                    <h1 className="font-eurostile xl:text-[32px] xl:leading-[32px] tracking-[0.14em] font-bold uppercase xl:max-w-[600px] xl:pt-7">
                        People at the core of excellence
                    </h1>
                    <div className="flex items-start xl:pt-28 xl:gap-28">
                        <div className="flex flex-col justify-center items-center ">
                            <h1 className="text-laranja font-bold font-eurostile xl:text-[38px] xl:leading-[38px] xl:-tracking-[0.05em]">
                                120
                            </h1>
