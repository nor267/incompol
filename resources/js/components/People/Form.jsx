    ...
    return (
        <div className="flex flex-col lg:flex-row items-center xl:gap-40 4xl:gap-53">
            <div className="xl:mt-38  relative flex-col-reverse flex justify-center items-center xl:items-start w-full xl:w-auto">
                ...
                ></img>
                <div className="absolute left-8 bottom-5 lg:left-30 xl:left-[100px] lg:bottom-[40px] xl:bottom-[120px] z-20 pb-2">
                    <h1
                        className="uppercase text-white font-eurostile text-[18px] leading-[22px] lg:text-[20px] xl:text-[29px] xl:leading-[35px] font-medium text-left"
