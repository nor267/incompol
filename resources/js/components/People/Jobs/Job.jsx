export default function Job({ image, title, date }) {
    return (
        <div className="relative w-full h-[220px] xl:h-[370px] 2xl:h-[450px] overflow-hidden hover:scale-105 duration-300 transition-all cursor-pointer">
            ...
            <div className="w-full h-full  z-20 absolute top-0 gradient-black-white-news">
                <div className="w-full h-full z-30 relative gradient-black-white-news2">
                    <h1 className="text-white uppercase text-[16px] xl:text-[24px] 2xl:text-[27px] xl:leading-[25px] tracking-[0.04em] absolute left-8 bottom-4 bottom-10 2xl:bottom-14 xl:left-9 z-20 font-semibold">
                        {title}
                    </h1>
