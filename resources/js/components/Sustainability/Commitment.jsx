        ...
        <>
            ...
            <div className="flex flex-col xl:flex-row justify-center items-center xl:gap-16 2xl:gap-29 mt-14 xl:mt-32 xl:mb-52 px-8 md:px-[80px] lg:px-0 xl:px-0">
                <div className="relative w-full xl:w-auto flex justify-end">
                    ...
                    <div className="bg-laranja w-[100px] h-[100px] md:w-[200px] md:h-[200px] xl:w-[280px] xl:h-[280px] 2xl:w-[300px] 2xl:h-[300px] rounded-full absolute -left-0 -top-10 md:left-0 xl:-left-20 2xl:-left-40 xl:-top-40 ">
                    ...
                    <img
                        src={certification}
                        className="absolute md:left-0 xl:-left-20 2xl:-left-40 xl:top-50 w-30 md:w-50 xl:w-60 -left-2 top-20 md:top-50"
                    ></img>
                </div>
                <div
